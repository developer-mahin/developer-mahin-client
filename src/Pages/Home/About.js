  ...
  return (
    <div className="lg:py-16 py-6 px-3" id="about-section">
      <div className="text-center" p-2 rounded-full bg-blue-400>
        <h1
          className="text-gray-300 lg:text-7xl text-5xl font-semibold"
          data-aos="fade-up"
        >
          About Me
        </h1>
        <h3
          className="lg:text-3xl text-xl font-semibold text-gray-800"
          data-aos="fade-up"
        >
      ...
      <div
        data-aos="zoom-in"
        className="md:flex gap-5 items-start justify-between sm:mx-10 md:mx-20 lg:mx-40 py-4"
      >
        {/* Details */}
                ...
                <Tab as={Fragment}>
                  {({ selected }) => (
                    <button
                      className={
                        selected
                          ? "bg-gradient-to-r from-cyan-500 to-blue-500 lg:px-6 py-2 px-3 rounded-full text-white font-medium text-sm"
                          : "text-gray-800 lg:px-6 py-2 px-3 text-sm shadow-lg rounded-full mx-2 border"
                      }
                    >
                      About Me
                    </button>
      ...
      <div
        className="md:flex gap-5 items-start justify-between sm:mx-10 md:mx-20 px-4 lg:mx-40 py-4"
        data-aos="zoom-in"
      >
