            ...
            <div>
                <PhotoProvider>
                    <PhotoView src={projectImg}>
                        <img className='w-full h-96 object-cover object-top cursor-pointer rounded-lg' src={projectImg} alt="" />
                    </PhotoView>
                </PhotoProvider>
            </div>
            <div className='p-6'>
                ...
                <Link
                    to={`/details/${_id}`}
                    className='bg-gradient-to-r from-cyan-500 to-blue-500 lg:px-5 py-3 rounded-full text-white font-medium button'>Explore More</Link>
            </div>
        </div>
    );
};
